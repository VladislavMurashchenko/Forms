  ...
  render() {
    return (
      <form className="app-form">
        ...
        <button className="app-form__btn app-form__btn_save" type="button">Save</button>
        <button className="app-form__btn app-form__btn_reject" type="button">Reject</button>
      </form>
    );
  }
}
